...
public class Sorting extends animationFrame {
 // Object of the SortingAlgorithm, which includes the sorting algorithms
	sortVisualizer sortAlgo = new sortVisualizer();
 ...
 JButton jbtRandomize, jbtBubble, jbtInsertion, jbtSelection, jbtStart;
 ...
 public Sorting(){
     ...
     pPanel1.add(jbtSelection); pPanel1.add(jbtBubble); pPanel1.add(jbtInsertion);
